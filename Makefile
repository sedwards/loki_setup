...
testcd: testcd.o $(CORE_OBJS) $(COMMON_OBJS) $(COMMON_LIBS)
	$(LD) $(LDFLAGS) -o $@ $^  -L/usr/local/lib -lutil   -liconv -lxml2 -lm    -lz   -lncurses  -ldl
